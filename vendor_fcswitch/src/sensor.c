...
int v_sensor_enable (i_resource *self)
{
  ...
  i_triggerset_addtrg (self, tset, "unknown", "Unknown", VALTYPE_FLOAT, TRGTYPE_EQUAL, 1, NULL, 0, NULL, 0, ENTSTATE_WARNING, TSET_FLAG_VALAPPLY);
  ...
  static_objfact = l_snmp_objfact_create (self, "sensor", "Sensor");
  if (!static_objfact)
  { 
  ...
  static_objfact->name_oid_str = strdup (".1.3.6.1.3.94.1.8.1.3");
