...
if [ -e "cache/lcipmitool_xs3" ]; then
  mkdir -p $LITHIUMPATH
  cp cache/lcipmitool_xs3 $LITHIUMPATH/lcipmitool_xs3
  cp cache/lcipmitool_xs1 $LITHIUMPATH/lcipmitool_xs1
  echo "[OK] Used cached IPMItool Build"
  exit 0
fi
