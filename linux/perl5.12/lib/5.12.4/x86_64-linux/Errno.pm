...
"x86_64-linux-2.6.32-24-generic" or
	die "Errno architecture (x86_64-linux-2.6.32-24-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
