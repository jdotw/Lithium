...
int v_expmodule_objform (i_resource *self, i_entity *ent, i_form_reqdata *reqdata)
{
  char *str;
...
int v_expmodule_objform_hist (i_resource *self, i_entity *ent, i_form_reqdata *reqdata)
{
//  i_object *obj = (i_object *) ent;
