...
int v_temp_cntform (i_resource *self, i_entity *ent, i_form_reqdata *reqdata)
{
  char *str;
  i_object *obj;
  v_temp_item *temp;
  ...
  i_form_metcgraph_add (self, reqdata->form_out, temp->temp_cg, GRAPHSIZE_SMALL, 0, GRAPHPERIOD_LAST48HR);
