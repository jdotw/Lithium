...
int l_snmp_nsload_objform (i_resource *self, i_entity *ent, i_form_reqdata *reqdata)
{
  char *str;
  i_object *obj = (i_object *) ent;
  l_snmp_nsload_item *load = obj->itemptr;

  /* 
   * Load averages
   */

  asprintf (&str, "Load Average Current Data", obj->desc_str);
...
int l_snmp_nsload_objform_hist (i_resource *self, i_entity *ent, i_form_reqdata *reqdata)
{
  i_object *obj = (i_object *) ent;
  l_snmp_nsload_item *load = obj->itemptr;
