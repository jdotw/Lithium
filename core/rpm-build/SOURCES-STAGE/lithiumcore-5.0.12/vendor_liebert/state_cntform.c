...
int v_state_cntform (i_resource *self, i_entity *ent, i_form_reqdata *reqdata)
{
  char *str;
  i_object *obj;
  v_state_item *state;
  ...
  i_form_metcgraph_add (self, reqdata->form_out, state->state_cg, GRAPHSIZE_SMALL, 0, GRAPHPERIOD_LAST48HR);
