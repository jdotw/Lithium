...
int l_snmp_nsdiskio_enable (i_resource *self)
{
  ...
  tset = i_triggerset_create ("read_tput", "Read Throughput", "read_tput");
	i_triggerset_addtrg (self, tset, "warning", "Warning", VALTYPE_FLOAT, TRGTYPE_GT, 100000000, NULL, 0, NULL, 0, ENTSTATE_WARNING, TSET_FLAG_VALAPPLY);
	tset->default_applyflag = 0;
  i_triggerset_assign (self, static_cnt, tset);

  tset = i_triggerset_create ("write_tput", "Write Throughput", "write_tput");
	i_triggerset_addtrg (self, tset, "warning", "Warning", VALTYPE_FLOAT, TRGTYPE_GT, 100000000, NULL, 0, NULL, 0, ENTSTATE_WARNING, TSET_FLAG_VALAPPLY);
	tset->default_applyflag = 0;
  i_triggerset_assign (self, static_cnt, tset);
