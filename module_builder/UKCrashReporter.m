...
-(IBAction)	sendCrashReport: (id)sender
{
	...
	// Prepare a request:
	NSString *urlString = [NSString stringWithFormat:@"http://lithium5.com/tech/reporter/modb_crash.php?from=%@", [[self userEmail] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
