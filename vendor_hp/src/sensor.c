...
/* HP Procurve Sensor Table  Sub-System */
...
int v_sensor_enable (i_resource *self)
{
  ...
  static_cnt = i_container_create ("hpsensor", "Sensors");
  if (!static_cnt)
  ...
  static_objfact = l_snmp_objfact_create (self, "sensor", "Chassis Sensors");
  if (!static_objfact)
  { 
  ...
  static_objfact->name_oid_str = strdup ("enterprises.11.2.14.11.1.2.6.1.7");
