...
PATH="/Developer/usr/bin:/Developer/usr/sbin:$PATH:/Library/Lithium/LithiumCore.app/Contents/MacOS" \
CFLAGS="-arch i386 -I/Library/Lithium/LithiumCore.app/Contents/Frameworks/LithiumCore.framework/Versions/5.0/Headers" \
