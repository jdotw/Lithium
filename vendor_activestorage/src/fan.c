...
int v_fan_enable (i_resource *self, int enclosure, char *oidindex_str)
{
  ...
  char *name_str;
  char *desc_str;
  asprintf (&name_str, "vtfan_%i", enclosure);
  ...
  i_triggerset_addtrg (self, tset, "error", "Error", VALTYPE_INTEGER, TRGTYPE_EQUAL, 3, NULL, 0, NULL, 0, ENTSTATE_IMPAIRED, TSET_FLAG_VALAPPLY);
