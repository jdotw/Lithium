...
@property (retain) NSString *footerTitle;
@property int year;
@property (retain) NSString *month;
@property (retain) NSString *shortMonth;
...
@property (retain) NSMutableArray *threeMth;
@property (retain) NSMutableArray *sixMth;
@property (retain) NSMutableArray *nineMth;
@property (retain) NSMutableArray *twelveMth;
@property (retain) NSString *reportFilename;
