//
//  LCBonjourBrowserTreeController.m
//  Lithium Console
//
...
#import "LCBonjourBrowserTreeController.h"
#import "LCBonjourService.h"

@implementation LCBonjourBrowserTreeController
	   ...
	   toPasteboard:(NSPasteboard *)pboard
{
	...
	for (id item in items)
	{
		...
		if (![[[item representedObject] class] isSubclassOfClass:[LCBonjourService class]])
		{ continue; }
		
		/* Add service properties to list */
		[propertyList addObject:[[(LCBonjourService *)[item representedObject] deviceTemplate] properties]];
	}
